...
export const uk: Dict = {
  ...
  'common.openInNewTab': 'Відкрити на новій вкладці',
  'common.exportPdf': 'Експортувати як PDF',
  'common.exportZip': 'Завантажити як .zip',
  'common.exportHtml': 'Експортувати як самостійний HTML',
  'common.justNow': 'щойно',
  'common.minutesAgo': '{n}хв назад',
  'common.hoursAgo': '{n}г назад',
  ...
  'settings.welcomeSubtitle':
    'Виберіть, як ви хочете запускати генерацію. Ви можете змінити це в будь-який час за допомогою кнопки Параметри в верхній панелі.',
  'settings.kicker': 'Параметри',
  ...
  'settings.modeDaemonOffline': 'Демон не запущений',
  ...
  'settings.mediaProvidersHint':
    'API-ключі для генерації зображень, відео та аудіо. Зберігаються локально та синхронізуються з локальним демоном.',
  ...
  'settings.versionUnavailable': 'Детали версії недоступні, поки демон перебуває в офлайні.',

  'entry.tabDesigns': 'Дизайни',
  'entry.tabExamples': 'Приклади',
  'entry.tabDesignSystems': 'Системи дизайну',
  'entry.openSettingsTitle': 'Параметри',
  'entry.openSettingsAria': 'Відкрити параметри',
  ...
  'newproj.fidelityWireframe': 'Каркас',
  ...
  'newproj.dsNoneFreeform': 'Жодна — вільна форма',
  ...
  'newproj.dsNoneTitle': 'Жодна — вільна форма',
  ...
  'examples.emptyNoSkills': 'Навички недоступні. Чи запущений демон?',
  ...
  'avatar.title': 'Обліковий запис та параметри',
  ...
  'chat.cliSettingsTitle': 'Параметри CLI та моделі',
  'chat.cliSettingsAria': 'Відкрити параметри CLI та моделі',
  ...
  'preview.openInNewTab': 'Відкрити на новій вкладці',
  'preview.exit': '⤓ Вихід',
  ...
  'fileViewer.openInNewTab': 'Відкрити на новій вкладці',
  ...
  'fileViewer.deployConfigSaveFailed': 'Не вдалося зберегти параметри Vercel.',
  'fileViewer.deployFailed': 'Розгортання не вдалося. Перевірте параметри Vercel та спробуйте ще раз.',
  ...
  'agentPicker.daemonOff': 'демон вимкнений',
  ...
  'pet.title': 'Домашні тварини',
  'pet.subtitle': 'Усиновити крихітного супутника, який пливе над вашим робочим простором.',
  'pet.navTitle': 'Домашні тварини',
  'pet.navHint': 'Усиновити або налаштувати',
  'pet.tabBuiltIn': 'Вбудовані',
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з Open Design — виберіть один та усиновіть.',
  'pet.builtInEmpty': 'Вбудовані домашні тварини наразі недоступні. Спробуйте оновити вкладку Спільнота, коли демон перейде в мережу.',
  'pet.tabCustom': 'Власна',
  'pet.tabCustomHint': 'Створіть свою власну назвою, гліфом, кольором або спрайтом.',
  'pet.tabCommunity': 'Спільнота',
  'pet.tabCommunityHint': 'Домашні тварини, створені Codex — усиновіть одну або створіть нову.',
  'pet.tabsAria': 'Джерело домашної тварини',
  'pet.adopt': 'Усиновити',
  'pet.adoptedBadge': 'Усиновлено',
  'pet.adoptCallout': 'Усиновити домашну тварину',
  'pet.changePet': 'Змінити домашну тварину',
  'pet.wake': 'Розбудити',
  'pet.tuck': 'Спховати',
  'pet.wakeTitle': 'Розбудити домашну тварину — показати плаваючу накладку.',
  'pet.tuckTitle': 'Спховати домашну тварину — приховати плаваючу накладку.',
  'pet.settingsTitle': 'Відкрити параметри домашної тварини',
  'pet.useCustom': 'Використовувати мою домашну тварину',
  ...
  'pet.railAria': 'Вибір домашної тварини',
  'pet.railTitle': 'Домашні тварини',
  'pet.railHint': 'Виберіть супутника для плавання над вашим робочим простором.',
  'pet.railExpand': 'Показати вибір домашної тварини',
  'pet.railCollapse': 'Згорнути вибір домашної тварини',
  'pet.railHide': 'Приховати вибір домашної тварини',
  'pet.railShow': 'Показати вибір домашної тварини',
  'pet.railCustomFlavor': 'Ваша власна — назва, гліф, колір.',
  'pet.railCustomize': 'Налаштувати…',
  'pet.composerTitle': 'Домашні тварини — розбудити, спховати або виберіть одну',
  'pet.composerMenuTitle': 'Домашні тварини',
  'pet.composerMenuHint': 'підказка: введіть /pet для перемикання',
  'pet.composerOpenSettings': 'Налаштування в параметрах',
  'pet.welcomeTeaserTitle': 'Усиновити домашну тварину',
  ...
  'pet.atlasPickerHint': 'Codex домашні тварини мають 9 рядків анімації. За замовчуванням ми зберігаємо повний атлас, щоб домашна тварина міняла рядки при наведенні, перетягуванні та простої. Ви також можете заморозити його на одному циклі.',
  ...
  'pet.slashPet': 'Перемикання, усиновлення або перехід до параметрів домашної тварини.',
  'pet.slashPetWake': 'Розбудити накладку плаваючої домашної тварини.',
  'pet.slashPetTuck': 'Спховати домашну тварину на цей час.',
  ...
  'pet.codexSubtitle': 'Домашні тварини, упаковані навичкою hatch-pet, з\'являються тут для усиновлення одним натисненням.',
  ...
  'pet.codexAdopt': 'Усиновити',
  'pet.codexAdopting': 'Усиновлення…',
  ...
  'settings.notifyDesktopBlocked': 'Сповіщення заблоковано браузером. Дозволіть їм у параметрах сайту.',
  ...
  'settings.notifyTestSent': 'Тестове сповіщення надіслано. Якщо банер не з\'явиться, перевірте параметри сповіщень браузера та системи.',
  'settings.notifyTestFailed': 'Помилка виклику сповіщення. Перевірте параметри сповіщень браузера та системи.',
